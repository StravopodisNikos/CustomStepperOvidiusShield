...
const PROGMEM unsigned char stepper_stepping_in_progress[]      = {240, 128, 128};     // LightCoral
...
const PROGMEM unsigned char stepper_updated_pos_indicator[]  	= {128, 128, 0};       // Olive
